...
class TextQueueStub:
    ...
    def enqueue(self, project_id: int, resource_id: int, task_type: str, payload: dict) -> dict:
        """
        Saves task to text_annotation_queue table.
        ...
        """
        logger.info(f"[QUEUE STUB] Enqueued {task_type} for project {project_id}")
